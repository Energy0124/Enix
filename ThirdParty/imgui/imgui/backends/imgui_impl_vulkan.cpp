...
void main()
{
    ...
    fColor.rgb = pow(fColor.rgb, vec3(2.2)).rgb; // reverse gamma correction
}
*/
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
    ...
    // Edit by energy0124: prefer to use SRGB to fix vulkan validation error when multiple viewports are used.
    // although it results in incorrect color, more on https://github.com/ocornut/imgui/issues/578
