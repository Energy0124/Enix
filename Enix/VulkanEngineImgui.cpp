...
namespace Enix
{
    VulkanEngineImgui::VulkanEngineImgui()
    {
        VulkanEngineImgui::init();
    }

    VulkanEngineImgui::~VulkanEngineImgui()
    {
        VulkanEngineImgui::cleanUp();
    }

    void VulkanEngineImgui::drawUI()
    {
    ...
    void VulkanEngineImgui::initWindow()
    {
        // Setup GLFW window
